...
- `VetoProposal` - Veto for house: House with Veto permission can veto any proposal in this DAO
- `Dissolve` - Dissolve for house: House with dissolve permission can dissolve this DAO
